	...
	initProperties: function() {
		...
		// Viewer.
			_.$viewer = $(
				'<div id="viewer">' +
					'<div class="inner">' +
						'<div class="nav-next icon fa-arrow-right" style="color:white;"></div>' +
						'<div class="nav-previous icon fa-arrow-right" style="color:white;"></div>' +
						'<div class="toggle icon fa-bars fa-2x" style="color:white;"> Menu</div>' +
					'</div>' +
				'</div>'
			).appendTo(_.$body);
